...
El desarrollo de la arquitectura general de todo el proyecto presenta una arquitectura de servicios con una comunicación REST. Apesar de dividir ciertas tareas en diferentes servicios, se presenta una arquitectura de servicios, puesto que mayor parte de la lógica de negocio se encuentra dentro del servidor Java Spring Boot, mientras que la tarea del reconocimiento facial fue la única que se separó de esta estructura debido al consumo de recursos.

Para una descripción más detallada sobre las estructuras internas de cada parte del sistema, así como la organización de cada sección, se puede consultar la sección \ref{ApendiceB}
