\subsection{Objetos de Transferencia de datos (DTO)}
Por última parte, en las (figuras \ref{fig:DTO1}, \ref{fig:DTO2}, \ref{fig:DTO3}, \ref{fig:DTO4}, \ref{fig:DTO5} y \ref{fig:DTO6}) , tenemos a las clases DTO. Estas clases, como se mencionó anteriormente, son utilizadas por las clases de tipo repositorio, servicio y controlador, por lo que son una pieza clave dentro del proyecto.
