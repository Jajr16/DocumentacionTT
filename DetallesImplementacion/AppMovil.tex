...
\begin{itemize}
	\item \textbf{`androidx.compose.foundation`:} Para componentes de interfaz de usuario de bajo nivel y funcionalidades de diseño como fondos, bordes y gestos.
	\item \textbf{`androidx.compose.material3`:} Proporciona componentes de Material Design 3, facilitando la creación de interfaces modernas y consistentes.
	\item \textbf{`androidx.compose.runtime`:} Contiene las APIs principales del tiempo de ejecución de Compose, fundamentales para la composición y recomposición de la interfaz de usuario.
	\item \textbf{`androidx.compose.ui`:} Incluye las APIs básicas de UI de Compose, como elementos gráficos, eventos de entrada y diseños.
	\item \textbf{`androidx.navigation.NavController`:} Es crucial para la gestión de la navegación entre las diferentes pantallas de la aplicación, permitiendo una experiencia de usuario fluida al moverse entre los distintos destinos Composables.
\end{itemize}
