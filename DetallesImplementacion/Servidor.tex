\section{Servidor Java Spring Boot}

El servidor principal está diseñado con Spring Boot y deplegado en Azure como un App Service. Su despliegue en la nube permite la disponibilidad en línea para poder ser consumido por otras aplicaciones, como el sistema web desarrollado en Django y la aplicación móvil desarrollada en Kotlin.
