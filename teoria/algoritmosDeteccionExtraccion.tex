...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.68\textwidth]{images/mtcnn_architecture}}
		\caption{Arquitectura de MTCNN.}
		\label{fig:Arquitectura de MTCNN}
	\end{center}
\end{figure}

La figura (figura \ref{fig:Arquitectura de MTCNN} fue obtenida de \cite{MTCNN_Paper})
...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.68\textwidth]{images/facenet_architecture}}
		\caption{Arquitectura general de FaceNet.}
		\label{fig:Arquitectura general de FaceNet}
	\end{center}
\end{figure}


La figura (figura \ref{fig:Arquitectura general de FaceNet} fue obtenida de \cite{FaceNet_Paper})
...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.50\textwidth]{images/triplet_loss}}
		\caption{Aprendizaje basado en tripletas.}
		\label{fig:Aprendizaje basado en tripletas}
	\end{center}
\end{figure}

La figura (figura \ref{fig:Aprendizaje basado en tripletas} fue obtenida de \cite{FaceNet_Paper})
...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.50\textwidth]{images/casia_subset}}
		\caption{Algunas muestras del conjunto de datos CASIA WebFace.}
		\label{fig:Conjunto de datos CASIA WebFace}
	\end{center}
\end{figure}

La figura (figura \ref{fig:Conjunto de datos CASIA WebFace} fue obtenida de \cite{CASIA})
...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.50\textwidth]{images/lfw_subset}}
		\caption{Algunas muestras del conjunto de datos LFW.}
		\label{fig:Algunos pares en el conjunto LFW}
	\end{center}
\end{figure}

La figura (figura \ref{fig:Algunos pares en el conjunto LFW} fue obtenida de \cite{LFW})
