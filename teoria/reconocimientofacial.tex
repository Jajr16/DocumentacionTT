...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.68\textwidth]{images/face_pipeline}}
		\caption{Pipeline moderno de un sistema de reconocimiento facial \cite{Face_OpenCV}.}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{Diferencia entre verificación e identificación de rostros. \cite{Face_OpenCV}.}
