...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.9\textwidth]{images/face_pipeline}}
		\caption{Pipeline moderno de un sistema de reconocimiento facial.}
		\label{fig:Pipeline de un sistema de reconocimiento facial}
	\end{center}
\end{figure}

La figura (figura \ref{fig:Pipeline de un sistema de reconocimiento facial} fue obtenida de \cite{Face_OpenCV}).
...
\begin{figure}[htbp]
	\begin{center}
		\fbox{\includegraphics[width=.68\textwidth]{images/face_verification_identification}}
...
La figura (figura \ref{fig:Diferencia entre verificación e identificación de rostros} fue obtenida de \cite{L14})
