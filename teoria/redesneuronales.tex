...
Como ya se mencionó con anterioridad, una red neuronal es un sistema complejo que busca imitar la forma en la que el cerebro humano aprende.
...
\begin{itemize}
	...
	\begin{equation}
		\label{eq:mse} % Etiqueta para referenciar la ecuación
		MSE = \frac{1}{n} \sum_{i=1}^{n} (y_i - \hat{y}_i)^2
	\end{equation}
	Donde $n$ es el número de muestras, $y_i$ son los valores reales y $\hat{y}_i$ son las predicciones.
	\nomenclature[eq]{$MSE$}{Error Cuadrático Medio} % Entra en la nomenclatura como una ecuación
