...
\begin{UseCase}{CU-33}{Dar de alta personal de seguridad}{
    ...
    \UCitem{Salidas}{Muestra mensaje {\bf ``Personal de seguridad dado de alta con éxito''.}}
    \UCitem{Destino}{-}
    ...
    \UCitem{Errores}{
        ...
        E2: Cuando el CURP del personal de seguridad ya está registrado en el sistema muestra el mensaje {\bf ``El CURP ya ha sido asociado a este personal de seguridad con anterioridad u otro personal de seguridad.''}
...
\begin{UCtrayectoria}
    ...
    \UCpaso El sistema muestra el mensaje {\bf ``Personal de seguridad dado de alta con éxito''.}
