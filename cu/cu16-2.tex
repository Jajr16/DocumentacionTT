...
\begin{UseCase}{CU-16}{Consultar periodos de ETS inscritos del alumno}{
	...
	\UCitem{Errores}{
			E1: El sistema no puede recuperar la información de los periodos y muestra el mensaje {\bf ``Error al consultar la base de datos. Intente nuevamente más tarde''}.
			
			E2:  No hay periodos de ETS y muestra el mensaje  {\bf ``No hay periodos de ETS''}. 
	}
...
\begin{UCtrayectoriaA}{A}{No hay periodos}
	...
	\UCpaso El sistema muestra un mensaje: {\bf ``No hay periodos de ETS''}
