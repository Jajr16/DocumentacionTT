...
\begin{UseCase}{CU-23}{Capturar fotografía estudiantil}{
    ...
    \UCitem{Errores}{
        ...
        E1: Cuando se pierde la conexión durante el proceso, los procesos se cancelan y se muestra el mensaje \bf ``El proceso no se pudo realizar por un fallo de red.''
    }
