...
\begin{UseCase}{CU-21}{Dar de alta un alumno}{
    ...
    \UCitem{Salidas}{Muestra mensaje \bf ``Alumno dado de alta con éxito''.}
    \UCitem{Destino}{-}
    \UCitem{Precondiciones}{El Personal de la DAE debe de haber iniciado sesión.}
    \UCitem{Postcondiciones}{-}
    \UCitem{Errores}{ 

        E1: Cuando falte algún dato requerido entonces el sistema muestra el mensaje {\bf``Los campos no están correctamente llenados.''}

        E2: Cuando la CURP o la boleta del alumno ya estén registradas en el sistema muestra el mensaje \bf ``La CURP o la boleta ya han sido asociadas a este alumno con anterioridad u otro alumno.''
...
\begin{UCtrayectoria}
    ...
    \UCpaso El Sistema le muestra el mensaje {\bf``Alumno dado de alta con éxito''}
