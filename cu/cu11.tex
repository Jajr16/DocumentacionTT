...
\begin{UseCase}{CU-11}{Mostrar la foto e información del alumno}{
	...
	\UCitem{Observaciones}{En caso de que las imágenes (foto de credencial o reconocimiento facial) no se carguen, se mostrará el mensaje "Sin Imagen" en su lugar.}
\end{UseCase}
%--------------------------------------
\begin{UCtrayectoria}
