...
\begin{UseCase}{CU-14}{Buscar alumno por nombre}{
	...
	\UCitem{Errores}{
			E1: El nombre ingresado no corresponde a ningún alumno registrado y muestra el mensaje {\bf ``Alumno no registrado''}.
			
			E2: El sistema no puede recuperar la información del alumno y muestra el mensaje {\bf ``Error al consultar la base de datos. Intente nuevamente más tarde.''}
	}
...
\begin{UCtrayectoriaA}{A}{Alumno no registrado}
	\UCpaso[\UCactor] El personal de seguridad muestra un mensaje: {\bf ``Alumno no registrado''}
