...
\begin{UseCase}{CU-20}{Revisar información de acceso a los ETS}{
	...
	\UCitem{Errores}{
		...
		E1: Cuando la información no esta disponible \textbf {``Error al recuperar la información del proceso. Intente nuevamente más tarde.''}
...
\begin{UCtrayectoriaA}{A}{Error al querer mostrar la información}
	...
	\UCpaso El sistema muestra el mensaje de error: \textbf{``Error al recuperar la información del proceso. Intente nuevamente más tarde.''}
