...
\begin{landscape}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.2\textheight]{images/DER} % Ojo: textheight porque estás en landscape
...
%---------------------------------------------------------
\begin{cdtEntidad}{Unidad academica}{unidadacademica}
...
\end{cdtEntidad}
%---------------------------------------------------------
\begin{cdtEntidad}{PersonalAcademico}{personalacademico}
...
\end{cdtEntidad}
%---------------------------------------------------------
\begin{cdtEntidad}{PS}{personalseguridad}
...
\end{cdtEntidad}
%---------------------------------------------------------
\begin{cdtEntidad}{TU}{tipousuario}
...
\end{cdtEntidad}
%---------------------------------------------------------
\begin{cdtEntidad}{PETS}{periodoets}
...
\end{cdtEntidad}
%---------------------------------------------------------
\begin{cdtEntidad}{UA}{unidadaprendizaje}
	\brAttr{Id\_UA}{Id\_UA}{varchar}
