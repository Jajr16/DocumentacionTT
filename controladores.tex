...
En las (figuras \ref{fig:DC1}, \ref{fig:DC2}, \ref{fig:DC3}, \ref{fig:DC4} y \ref{fig:DC5}), se presentan los diagramas de las clases de los controladores junto con sus respectivas propiedades.
