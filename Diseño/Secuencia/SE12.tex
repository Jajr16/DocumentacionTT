...
\begin{figure}[htbp!]
	\begin{center}
		\fbox{\includegraphics[width=1.2\textwidth]{Secuencia/CU-12.png}}
...
En este diagrama de secuencia (figura \ref{fig:Diagrama de secuencia CU-12}) se describe el proceso planeado para el caso de uso \hyperlink{CU-12}{CU-12 Consultar alumno mediante código QR de la credencial}, mostrando las interacciones que tendrá con la vista, el controlador, el servicio, el repositorio y la base de datos.
