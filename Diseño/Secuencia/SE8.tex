...
\begin{figure}[htbp!]
	\begin{center}
		\fbox{\includegraphics[width=0.85\textwidth]{Secuencia/CU-08.png}}
...
En este diagrama de secuencia (figura  \ref{fig:Diagrama de secuencia CU-08}) se describe el proceso planeado para el caso de uso \hyperlink{CU-08}{CU-08 Consultar lista de alumnos inscritos a un ETS}, mostrando las interacciones que tendrá con la vista, el controlador, el servicio, el repositorio y la base de datos.
