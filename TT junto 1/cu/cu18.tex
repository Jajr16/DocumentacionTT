...
%--------------------------------------
\begin{UCtrayectoria}
	\UCpaso[\UCactor] El alumno presiona el boton \IUbutton{Consultar periodo de ETS} en la pantalla \IUref{IUE03}{de saludo del alumno} y lo redirige a la pantalla \IUref{IU15}{Pantalla Consultar ETS del alumno}.
