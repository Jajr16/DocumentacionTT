...
\begin{UCtrayectoria}
    \UCpaso[\UCactor] El usuario accede a la pantalla \IUref{IU03}{Pantalla Consultar notificaciones}\label{CU03.introduceDatos} para la app móvil y \IUref{IU03-2}{Pantalla Consultar notificaciones} para el sistema web mediante el botón con forma de campana en cualquier pantalla excepto los inicios de sesión.
